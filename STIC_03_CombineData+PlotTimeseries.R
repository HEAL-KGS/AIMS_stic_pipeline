...
###  - NOTE THE EDITS IN THE README.txt FILE
###  - THEN RUN THIS SCRIPT
###    (you can rerun the script if you notice something wrong and make a change)
...
last_date <- ymd_hms("2023-10-21 00:00:00") # make it a bit after the last date for last download
